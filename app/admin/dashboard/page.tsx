  ...
  return (
    <SidebarShell nav={adminNav} eyebrow="Company admin" title="Revenue command center">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <MetricCard label="Admin direct profit" value={currency(metrics.adminDirectProfitCents / 100)} change={`${metrics.adminDirectOrderCount} admin direct sales`} tone="green" info="Profit from paid orders created directly by admin, without a agent or partner attached." />
