  ...
  return (
    <SidebarShell nav={consultantNav} eyebrow="Consultant" title="Sales performance">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        <MetricCard label="Collected revenue" value={currency(metrics.revenueCents / 100)} change={`${metrics.paidOrderCount} paid orders`} info="Captured order totals from your personal sales in the selected date range." />
        <MetricCard label="Commission earned" value={currency(metrics.commissionCents / 100)} change="Real earnings from captured payments" tone="green" info="Your seller commission split generated by captured orders in this date range." />
        <MetricCard label="Pending commissions" value={currency(metrics.pendingCommissionCents / 100)} change="Awaiting payout approval" tone="red" info="Your seller commission splits still marked pending for captured orders." />
        <MetricCard label="Assigned customers" value={`${metrics.customerCount}`} change="Customers assigned to you" info="Customers assigned to your seller profile and created inside the selected date range." />
      </div>
