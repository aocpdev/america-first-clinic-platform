        ...
        <form action={action} className="grid max-h-[calc(92vh-120px)] gap-5 overflow-y-auto p-6">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <Field label="Last name">
              <Input name="lastName" defaultValue={customer?.lastName ?? ""} placeholder="Last name" />
            </Field>
            <Field label="Email">
            ...
            <Field label="Date of birth">
              <Input name="dateOfBirth" type="date" defaultValue={dateInputValue(customer?.dateOfBirth)} />
            </Field>
