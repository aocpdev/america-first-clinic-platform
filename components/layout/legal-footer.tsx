    ...
    <footer className={compact ? "mt-6 text-center" : "border-t border-border bg-white"}>
      <div className={compact ? "" : "mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8"}>
        <p className="text-xs leading-5 text-slate-500">
          America First Clinic is operated by ACV2 Investment Group LLC.
        </p>
        <nav className="mt-3 flex flex-wrap justify-center gap-x-4 gap-y-2 text-xs font-semibold text-slate-500">
          {legalLinks.map((link) => (
