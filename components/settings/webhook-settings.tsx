...
const events = [
  ...
  { value: "invoice.requested", label: "Invoice requested", group: "Payments", description: "An agent requests an invoice/payment link." },
  ...
  { value: "seller.registration.submitted", label: "Agent registration submitted", group: "Team access", description: "An agent applies under a partner or leader." },
  ...
  { value: "seller.approved", label: "Agent approved", group: "Team access", description: "An agent is approved and can access the CRM." },
  ...
  { value: "seller.rejected", label: "Agent rejected", group: "Team access", description: "An agent application is rejected." },
  ...
  { value: "consultant.approved", label: "Agent approved legacy", group: "Legacy", description: "Legacy event kept for existing workflows." },
  { value: "consultant.rejected", label: "Agent rejected legacy", group: "Legacy", description: "Legacy event kept for existing workflows." },
